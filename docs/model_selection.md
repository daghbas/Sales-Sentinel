...
The accuracy remains unsuitable for production. The model is retained to demonstrate a truthful forecasting pipeline, quantile intervals, persistence and monitoring until a 24–36 month dataset is available.
